...
function useStructureToolSetting(namespace, key, defaultValue) {
  const keyValueStore = sanity.useKeyValueStore(), keyValueStoreKey = [STRUCTURE_TOOL_NAMESPACE, namespace, key].filter(Boolean).join("."), value$ = React.useMemo(() => keyValueStore.getKey(keyValueStoreKey).pipe(operators.map((value2) => value2 === null ? defaultValue : value2)), [defaultValue, keyValueStore, keyValueStoreKey]), value = reactRx.useObservable(value$, defaultValue), set = React.useCallback(
    (newValue) => {
...
function DocumentStatusBar(props) {
  const { actionsBoxRef, createLinkMetadata } = props, { editState, timelineStore, onChange: onDocumentChange } = useDocumentPane(), { title } = useDocumentTitle(), CreateLinkedActions = sanity.useSanityCreateConfig().components?.documentLinkedActions, showingRevision = sanity.useTimelineSelector(timelineStore, (state2) => state2.onOlderRevision), [collapsed, setCollapsed] = React.useState(null), [rootElement, setRootElement] = React.useState(null), handleResize = React.useCallback((event) => {
    setCollapsed(event.contentRect.width < CONTAINER_BREAKPOINT);
  }, []);
  useResizeObserver({ element: rootElement, onResize: handleResize });
  const shouldRender = editState?.ready && typeof collapsed == "boolean";
  let actions = null;
  return createLinkMetadata && sanity.isSanityCreateLinked(createLinkMetadata) && CreateLinkedActions ? actions = /* @__PURE__ */ jsxRuntime.jsx(
    CreateLinkedActions,
    {
  ...
  ) : showingRevision ? actions = /* @__PURE__ */ jsxRuntime.jsx(HistoryStatusBarActions, {}) : actions = /* @__PURE__ */ jsxRuntime.jsx(DocumentStatusBarActions, {}), /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { direction: "column", ref: setRootElement, sizing: "border", children: shouldRender && /* @__PURE__ */ jsxRuntime.jsxs(
    ui.Flex,
    {
      align: "stretch",
      gap: 1,
    ...
    /* @__PURE__ */ jsxRuntime.jsx(sanity.FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY, children: /* @__PURE__ */ jsxRuntime.jsxs(
      DocumentActionShortcuts,
      {
        ...
        children: [
          ...
          createLinkMetadata && sanity.isSanityCreateLinked(createLinkMetadata) && CreateLinkedBannerContent && /* @__PURE__ */ jsxRuntime.jsx(ShowWhenPaneOpen, { children: /* @__PURE__ */ jsxRuntime.jsx(
            Banner,
            {
              tone: "transparent",
              "data-test-id": "sanity-create-read-only-banner",
              content: /* @__PURE__ */ jsxRuntime.jsx(CreateLinkedBannerContent, { metadata: createLinkMetadata })
            }
          ) }),
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.PortalProvider,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(ui.DialogProvider, { position: DIALOG_PROVIDER_POSITION, zOffset: zOffsets.portal, children: /* @__PURE__ */ jsxRuntime.jsx(PaneFooter, { ref: setFooterElement, children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.TooltipDelayGroupProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(
                DocumentStatusBar,
                {
...
function useDocumentList(opts) {
  ...
  }), { strategy: searchStrategy } = sanity.useWorkspace().search, schema = sanity.useSchema(), maxFieldDepth = sanity.useSearchMaxFieldDepth(), typeNameFromFilter = React.useMemo(
