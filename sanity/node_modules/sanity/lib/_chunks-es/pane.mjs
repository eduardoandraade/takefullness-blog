...
function useStructureToolSetting(namespace, key, defaultValue) {
  const keyValueStore = useKeyValueStore(), keyValueStoreKey = [STRUCTURE_TOOL_NAMESPACE, namespace, key].filter(Boolean).join("."), value$ = useMemo(() => keyValueStore.getKey(keyValueStoreKey).pipe(map((value2) => value2 === null ? defaultValue : value2)), [defaultValue, keyValueStore, keyValueStoreKey]), value = useObservable(value$, defaultValue), set = useCallback(
    (newValue) => {
...
function DocumentStatusBar(props) {
  const { actionsBoxRef, createLinkMetadata } = props, { editState, timelineStore, onChange: onDocumentChange } = useDocumentPane(), { title } = useDocumentTitle(), CreateLinkedActions = useSanityCreateConfig().components?.documentLinkedActions, showingRevision = useTimelineSelector(timelineStore, (state2) => state2.onOlderRevision), [collapsed, setCollapsed] = useState(null), [rootElement, setRootElement] = useState(null), handleResize = useCallback((event) => {
    setCollapsed(event.contentRect.width < CONTAINER_BREAKPOINT);
  }, []);
  useResizeObserver({ element: rootElement, onResize: handleResize });
  const shouldRender = editState?.ready && typeof collapsed == "boolean";
  let actions = null;
  return createLinkMetadata && isSanityCreateLinked(createLinkMetadata) && CreateLinkedActions ? actions = /* @__PURE__ */ jsx(
    CreateLinkedActions,
    {
  ...
  ) : showingRevision ? actions = /* @__PURE__ */ jsx(HistoryStatusBarActions, {}) : actions = /* @__PURE__ */ jsx(DocumentStatusBarActions, {}), /* @__PURE__ */ jsx(Flex, { direction: "column", ref: setRootElement, sizing: "border", children: shouldRender && /* @__PURE__ */ jsxs(
    Flex,
    {
      align: "stretch",
      gap: 1,
    ...
    /* @__PURE__ */ jsx(FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY, children: /* @__PURE__ */ jsxs(
      DocumentActionShortcuts,
      {
        ...
        children: [
          ...
          createLinkMetadata && isSanityCreateLinked(createLinkMetadata) && CreateLinkedBannerContent && /* @__PURE__ */ jsx(ShowWhenPaneOpen, { children: /* @__PURE__ */ jsx(
            Banner,
            {
              tone: "transparent",
              "data-test-id": "sanity-create-read-only-banner",
              content: /* @__PURE__ */ jsx(CreateLinkedBannerContent, { metadata: createLinkMetadata })
            }
          ) }),
          ...
          /* @__PURE__ */ jsx(
            PortalProvider,
            {
              ...
              children: /* @__PURE__ */ jsx(DialogProvider, { position: DIALOG_PROVIDER_POSITION, zOffset: zOffsets.portal, children: /* @__PURE__ */ jsx(PaneFooter, { ref: setFooterElement, children: /* @__PURE__ */ jsx(TooltipDelayGroupProvider, { children: /* @__PURE__ */ jsx(
                DocumentStatusBar,
                {
...
function useDocumentList(opts) {
  ...
  }), { strategy: searchStrategy } = useWorkspace().search, schema = useSchema(), maxFieldDepth = useSearchMaxFieldDepth(), typeNameFromFilter = useMemo(
