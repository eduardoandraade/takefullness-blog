...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources4-XZEX4UNS.js")
});
...
function useStructureToolSetting(namespace, key, defaultValue) {
  const keyValueStore = useKeyValueStore(), keyValueStoreKey = [STRUCTURE_TOOL_NAMESPACE, namespace, key].filter(Boolean).join("."), value$ = (0, import_react.useMemo)(() => keyValueStore.getKey(keyValueStoreKey).pipe(map((value2) => value2 === null ? defaultValue : value2)), [defaultValue, keyValueStore, keyValueStoreKey]), value = useObservable(value$, defaultValue), set = (0, import_react.useCallback)(
    (newValue) => {
...
function DocumentStatusBar(props) {
  var _a;
  const { actionsBoxRef, createLinkMetadata } = props, { editState, timelineStore, onChange: onDocumentChange } = useDocumentPane(), { title } = useDocumentTitle(), CreateLinkedActions = (_a = useSanityCreateConfig().components) == null ? void 0 : _a.documentLinkedActions, showingRevision = useTimelineSelector(timelineStore, (state2) => state2.onOlderRevision), [collapsed, setCollapsed] = (0, import_react.useState)(null), [rootElement, setRootElement] = (0, import_react.useState)(null), handleResize = (0, import_react.useCallback)((event) => {
    setCollapsed(event.contentRect.width < CONTAINER_BREAKPOINT);
  }, []);
  useResizeObserver({ element: rootElement, onResize: handleResize });
  const shouldRender = (editState == null ? void 0 : editState.ready) && typeof collapsed == "boolean";
  let actions = null;
  return createLinkMetadata && isSanityCreateLinked(createLinkMetadata) && CreateLinkedActions ? actions = (0, import_jsx_runtime.jsx)(
    CreateLinkedActions,
    {
  ...
  ) : showingRevision ? actions = (0, import_jsx_runtime.jsx)(HistoryStatusBarActions, {}) : actions = (0, import_jsx_runtime.jsx)(DocumentStatusBarActions, {}), (0, import_jsx_runtime.jsx)(Flex, { direction: "column", ref: setRootElement, sizing: "border", children: shouldRender && (0, import_jsx_runtime.jsxs)(
    Flex,
    {
      align: "stretch",
      gap: 1,
    ...
    (0, import_jsx_runtime.jsx)(FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY, children: (0, import_jsx_runtime.jsxs)(
      DocumentActionShortcuts,
      {
        ...
        children: [
          ...
          createLinkMetadata && isSanityCreateLinked(createLinkMetadata) && CreateLinkedBannerContent && (0, import_jsx_runtime.jsx)(ShowWhenPaneOpen, { children: (0, import_jsx_runtime.jsx)(
            Banner,
            {
              tone: "transparent",
              "data-test-id": "sanity-create-read-only-banner",
              content: (0, import_jsx_runtime.jsx)(CreateLinkedBannerContent, { metadata: createLinkMetadata })
            }
          ) }),
          ...
          (0, import_jsx_runtime.jsx)(
            PortalProvider,
            {
              ...
              children: (0, import_jsx_runtime.jsx)(DialogProvider, { position: DIALOG_PROVIDER_POSITION, zOffset: zOffsets.portal, children: (0, import_jsx_runtime.jsx)(PaneFooter, { ref: setFooterElement, children: (0, import_jsx_runtime.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime.jsx)(
                DocumentStatusBar,
                {
...
function useDocumentList(opts) {
  ...
  }), { strategy: searchStrategy } = useWorkspace().search, schema = useSchema(), maxFieldDepth = useSearchMaxFieldDepth(), typeNameFromFilter = (0, import_react.useMemo)(
    ...
    tools: [
      {
        ...
        icon,
        component: (0, import_react.lazy)(() => import("./index3-MI4PN6CI.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-74UCLCZN.js.map
