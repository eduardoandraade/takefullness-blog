import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-74UCLCZN.js";
import "./chunk-TA7ATT44.js";
import {
  Button,
  ErrorBoundary,
  NEVER,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-ZHVTFWZT.js")),
  document: (0, import_react.lazy)(() => import("./pane-SPIIZOOY.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-SPIIZOOY.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-YKPY7TCW.js"))
};
...
//# sourceMappingURL=index3-MI4PN6CI.js.map
