...
var createLocaleStrings = defineLocalesResources("create", {
  ...
  "start-in-create-dialog.lede": "Author in a free-form editor and have it mapped back to the Studio as structured content, as you type.",
  /** The details on what "Start writing in Create" implies */
  "start-in-create-dialog.details": "This will open Sanity Create in a new window and automatically link it to this document.",
  ...
  "linking-in-progress-dialog.lede": "Please return to Sanity Create. Linking the document should only take a few seconds.",
  /** Details for the "Linking in progress" dialog */
  "linking-in-progress-dialog.details": "When complete, this dialog will close and edits made in Sanity Create will start appearing here as they happen.",
  /** "Linking in progress" troubleshooting button title */
  "linking-in-progress-dialog.troubleshooting.button.title": "Linking taking a while?",
  /** "Linking in progress" troubleshooting content */
  "linking-in-progress-dialog.troubleshooting.content": "Did you close the Sanity Create window? Does the process appear to be stuck? Please reload this page and try again.",
  ...
  "create-link-info-popover.text": "Sanity Create lets you author in a free-form editor that automatically maps back to the Studio as structured content - as you type.",
  ...
  "unlink-from-create-dialog.second-paragraph": "You’ll keep all of your current changes, but future edits made in Create will no longer be automatically transferred here.",
...
//# sourceMappingURL=resources3-FMFUD43F.js.map
