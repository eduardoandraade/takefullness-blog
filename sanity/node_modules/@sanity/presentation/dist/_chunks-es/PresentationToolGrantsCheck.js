...
import { optional, object, pipe, minLength, string, record, unknown, SharedStateContext, presentationLocaleNamespace, usePresentationTool, PresentationSpinner, PresentationNavigateContext, PresentationParamsContext, PresentationContext, API_VERSION, ACTION_IFRAME_RELOAD, MAX_TIME_TO_OVERLAYS_CONNECTION, ACTION_IFRAME_LOADED, presentationReducer, presentationReducerInit, ACTION_VISUAL_EDITING_OVERLAYS_TOGGLE, ACTION_IFRAME_REFRESH, COMMENTS_INSPECTOR_NAME, EDIT_INTENT_MODE, DEFAULT_TOOL_NAME } from "./index.js";
...
function PresentationTool(props) {
  ...
  }, []), isLoading = state.iframe.status === "loading";
  useEffect(() => {
